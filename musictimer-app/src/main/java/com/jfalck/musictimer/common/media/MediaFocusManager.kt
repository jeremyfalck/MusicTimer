package com.jfalck.musictimer.common.media
...
class MediaFocusManager(private val context: Context) : OnAudioFocusChangeListener {
    ...
    fun requestMediaFocus() {
        ...
        val focusRequest = AudioFocusRequest.Builder(AudioManager.AUDIOFOCUS_GAIN).run {
            ...
            setOnAudioFocusChangeListener(this@MediaFocusManager, handler)
            build()
        }
